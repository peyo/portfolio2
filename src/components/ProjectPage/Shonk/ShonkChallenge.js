      ...
      <section className="shonkChallenge__section">
        <div className="shonkChallenge__container">
          ...
          <div className="shonkChallenge__description">
            Create a link shortener application. The goal was to build a full-stack React web app to write data through a GraphQL back-end. Once a user created data through the form, the inputted information would appear in a list below the form. I also limited myself to mobile-first responsive layout and styling using Material UI.

            Non-requirements: The challenge did not expect a fully working URL shortener. For example, it is not required for a working redirect when clicking on a shortened URL.
          </div>
        </div>
      </section>
    );
