      ...
      <section className="wordLearnings__section">
        <div className="wordLearnings__container">
          ...
          <div className="wordLearnings__description">
            Initially, the content sections weren't obvious. Different typography provided a clear content hierarchy. Also, the poem and lyrics were too long. A show more or show less button shortens the length of the content.
          </div>
        </div>
      </section>
    );
