      ...
      <section className="header__header">
        ...
        <div className="header__container">
          ...
          <div className="header__shortBio">
            ...
            diligence, lead to great outcomes. These traits afford us the
            ability to tackle new challenges. Check out my explorations,
            applying curiosity and self-discipline to create simple to complex
            solutions.
          </div>
